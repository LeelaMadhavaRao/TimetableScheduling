...
VALUES 
  ...
  ('50000000-0000-0000-0001-000000000003', 'ENG-LAB1', 40, 'lab', 'Engineering Block', 2, '10000000-0000-0000-0000-000000000001'),
  ('50000000-0000-0000-0001-000000000004', 'ENG-LAB2', 40, 'lab', 'Engineering Block', 2, '10000000-0000-0000-0000-000000000001')
...
VALUES 
  ...
  ('50000000-0000-0000-0002-000000000003', 'SCI-LAB1', 35, 'lab', 'Science Block', 2, '10000000-0000-0000-0000-000000000002'),
  ('50000000-0000-0000-0002-000000000004', 'SCI-LAB2', 35, 'lab', 'Science Block', 2, '10000000-0000-0000-0000-000000000002')
ON CONFLICT (name) DO UPDATE SET 
  capacity = EXCLUDED.capacity,
  created_by = EXCLUDED.created_by;
